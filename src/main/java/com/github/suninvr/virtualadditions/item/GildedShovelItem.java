...
public class GildedShovelItem extends Item implements GildedToolItem {
    ...
    public GildedShovelItem(GildType gildType, ToolMaterial baseMaterial, ShovelItem baseItem, Settings settings) {
        super(GildedToolUtil.settingsOf(gildType.getModifiedMaterial(baseMaterial).asToolMaterial().applyToolSettings(settings, BlockTags.SHOVEL_MINEABLE, baseMaterial.attackDamageBonus(), baseMaterial.speed(), 0.0F), baseItem, gildType));
