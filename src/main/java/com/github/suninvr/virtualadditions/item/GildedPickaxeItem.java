...
public class GildedPickaxeItem extends Item implements GildedToolItem {
    ...
    public GildedPickaxeItem(GildType gildType, ToolMaterial baseMaterial, PickaxeItem baseItem, Settings settings) {
        super(GildedToolUtil.settingsOf(gildType.getModifiedMaterial(baseMaterial).asToolMaterial().applyToolSettings(settings, BlockTags.PICKAXE_MINEABLE, ((MiningToolItemInterface)baseItem).getAttackDamage(), ((MiningToolItemInterface)baseItem).getAttackSpeed()), baseItem, gildType));
