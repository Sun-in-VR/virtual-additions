...
public final class VAItemTagProvider {
    ...
    private static class BaseProvider extends Provider {
        ...
        protected void configure(RegistryWrapper.WrapperLookup arg) {
            ...
            getOrCreateTagBuilder(ItemTags.FLOWERS).add(VAItems.BLUE_PETALS, VAItems.SPRING_LOTUS);
            getOrCreateTagBuilder(ItemTags.BEE_FOOD).add(VAItems.BLUE_PETALS, VAItems.SPRING_LOTUS);
