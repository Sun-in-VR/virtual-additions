...
public class VAModels {
    ...
    public static final ModelTemplate SPEAR_IN_HAND_TWO_LAYERS = item(ResourceLocation.withDefaultNamespace("spear_in_hand"), TextureSlot.LAYER0, TextureSlot.LAYER1);
    ...
    private static ModelTemplate item(ResourceLocation parent, TextureSlot... requiredTextureKeys) {
