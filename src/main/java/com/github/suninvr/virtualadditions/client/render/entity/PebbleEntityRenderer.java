...
public class PebbleEntityRenderer extends EntityRenderer<PebbleEntity, EntityRenderState> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("virtual_additions", "textures/entity/pebble.png");
    private static final RenderType LAYER;

    public PebbleEntityRenderer(EntityRendererProvider.Context ctx) {
        super(ctx);
    }
