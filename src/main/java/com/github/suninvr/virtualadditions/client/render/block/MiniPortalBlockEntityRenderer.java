...
public class MiniPortalBlockEntityRenderer implements BlockEntityRenderer<MiniPortalBlockEntity, MiniPortalBlockEntityRenderState> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/open.png");
    private static final ResourceLocation TEXTURE_BLOCKED = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/blocked.png");
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/open_glow.png");
    private static final ResourceLocation TEXTURE_BLOCKED_GLOW = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/blocked_glow.png");
    private static final ResourceLocation TEXTURE_DYED = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/dyed_open.png");
    private static final ResourceLocation TEXTURE_DYED_BLOCKED = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/dyed_blocked.png");
    private static final ResourceLocation TEXTURE_DYED_GLOW = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/dyed_open_glow.png");
    private static final ResourceLocation TEXTURE_DYED_BLOCKED_GLOW = ResourceLocation.fromNamespaceAndPath("virtual_additions", "textures/entity/mini_portal/dyed_blocked_glow.png");
