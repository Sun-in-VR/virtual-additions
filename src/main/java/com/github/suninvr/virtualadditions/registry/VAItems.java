...
public class VAItems {
    ...
    static {
        ...
        SCULK_DIAMOND_TOOL_SET = registerGildedToolSet(DIAMOND_TOOL_SET, GildType.SCULK);
        ...
        SCULK_IRON_TOOL_SET = registerGildedToolSet(IRON_TOOL_SET, GildType.SCULK);
        ...
        SCULK_GOLDEN_TOOL_SET = registerGildedToolSet(GOLDEN_TOOL_SET, GildType.SCULK);
        ...
        SCULK_NETHERITE_TOOL_SET = registerGildedToolSet(NETHERITE_TOOL_SET, GildType.SCULK);
        ...
        SCULK_STEEL_TOOL_SET = registerGildedToolSet(STEEL_TOOL_SET, GildType.SCULK);
