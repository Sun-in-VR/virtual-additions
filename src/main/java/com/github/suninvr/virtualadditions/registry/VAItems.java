...
public class VAItems {
    ...
    static {
        ...
        STEEL_SPEAR = register("steel_spear", new Item.Properties().spear(SteelToolMaterial.INSTANCE, 1.00F, 1.00F, 0.55F, 2.75F, 7.75F, 6.625F, 5.1F, 10.625F, 4.6F), CreativeModeTabs.COMBAT, Items.GOLDEN_SPEAR);
