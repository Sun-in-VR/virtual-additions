...
public class VADyeColors {
    ...
    public static final ColoringStationBlockEntity.DyeContents LIGHT_GRAY_COST = new ColoringStationBlockEntity.DyeContents(0, 0, 0, 0, 1, 3); // 3rd's
    ...
    public static final ColoringStationBlockEntity.DyeContents SINOPIA_COST = new ColoringStationBlockEntity.DyeContents(3, 0, 0, 1, 0, 0); // 3rd's
    ...
    public static final ColoringStationBlockEntity.DyeContents VIRIDIAN_COST = new ColoringStationBlockEntity.DyeContents(0, 3, 1, 0, 0, 0); // 3rd's
    ...
    public static final ColoringStationBlockEntity.DyeContents INDIGO_COST = new ColoringStationBlockEntity.DyeContents(1, 0, 3, 0, 0, 0); // 3rd's
