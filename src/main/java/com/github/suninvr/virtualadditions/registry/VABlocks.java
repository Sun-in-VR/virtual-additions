...
public class VABlocks {
    ...
    static {
        ...
        ROCK_SALT_BRICKS = register("rock_salt_bricks", Block::new, Settings.copy(ROCK_SALT_BLOCK).sounds(BlockSoundGroup.TUFF_BRICKS));
        ...
        WISDOM_BERRY = register("wisdom_berry", WisdomBerryCropBlock::new, Settings.create().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP));
        ...
        STRIPPED_SOULBLOOM_LOG = register("stripped_soulbloom_log", PillarBlock::new, Settings.copy(Blocks.STRIPPED_CHERRY_LOG));
        STRIPPED_SOULBLOOM_WOOD = register("stripped_soulbloom_wood", PillarBlock::new, Settings.copy(Blocks.STRIPPED_CHERRY_WOOD));
        SOULBLOOM_PLANKS = register("soulbloom_planks", Block::new, Settings.copy(Blocks.CHERRY_PLANKS));
        SOULBLOOM_STAIRS = register("soulbloom_stairs", (settings) -> new StairsBlock(SOULBLOOM_PLANKS.getDefaultState(), settings), Settings.copy(Blocks.CHERRY_STAIRS));
        SOULBLOOM_SLAB = register("soulbloom_slab", SlabBlock::new, Settings.copy(Blocks.CHERRY_SLAB));
        SOULBLOOM_FENCE = register("soulbloom_fence", FenceBlock::new, Settings.copy(Blocks.CHERRY_SLAB));
        SOULBLOOM_FENCE_GATE = register("soulbloom_fence_gate", (settings) -> new FenceGateBlock(SOULBLOOM_WOODTYPE, settings), Settings.copy(Blocks.CHERRY_SLAB));
        SOULBLOOM_DOOR = register("soulbloom_door", (settings) -> new DoorBlock( SOULBLOOM, settings), Settings.copy(Blocks.CHERRY_DOOR));
        SOULBLOOM_TRAPDOOR = register("soulbloom_trapdoor", (settings) -> new TrapdoorBlock( SOULBLOOM, settings), Settings.copy(Blocks.CHERRY_DOOR));
        SOULBLOOM_PRESSURE_PLATE = register("soulbloom_pressure_plate", (settings) -> new PressurePlateBlock(SOULBLOOM, settings), Settings.copy(Blocks.CHERRY_BUTTON));
        SOULBLOOM_BUTTON = register("soulbloom_button", (settings) -> new ButtonBlock(SOULBLOOM, 30, settings), Settings.copy(Blocks.CHERRY_BUTTON));
        SOULBLOOM_SIGN = register("soulbloom_sign", (settings) -> new CustomSignBlocks.CustomSignBlock(settings, SOULBLOOM_WOODTYPE), Settings.copy(Blocks.CHERRY_SIGN));
    ...
    public static void init(){
        ...
        fire.registerFlammableBlock(SOULBLOOM_LOG, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_WOOD, 5, 20);
        fire.registerFlammableBlock(STRIPPED_SOULBLOOM_LOG, 5, 20);
        fire.registerFlammableBlock(STRIPPED_SOULBLOOM_WOOD, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_PLANKS, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_STAIRS, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_SLAB, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_FENCE, 5, 20);
        fire.registerFlammableBlock(SOULBLOOM_LEAVES, 30, 60);
        fire.registerFlammableBlock(SOULBLOOM_HEDGE, 30, 60);
