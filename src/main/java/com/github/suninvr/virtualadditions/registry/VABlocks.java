...
public class VABlocks {
    ...
    static {
        ...
        AEROBLOOM_LEAVES = register("aerobloom_leaves", (settings) -> new UntintedParticleLeavesBlock(0.1F, VAParticleTypes.AEROBLOOM_LEAVES, settings), Settings.copy(Blocks.CHERRY_LEAVES));
