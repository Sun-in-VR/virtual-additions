...
public class VABlocks {
    ...
    public static final Block COLD_GREEN_WOOL;
    public static final Block COLD_GREEN_CARPET;
    public static final Block COLD_GREEN_TERRACOTTA;
    public static final Block COLD_GREEN_CONCRETE;
    public static final Block COLD_GREEN_CONCRETE_POWDER;
    public static final Block COLD_GREEN_STAINED_GLASS;
    public static final Block COLD_GREEN_STAINED_GLASS_PANE;
    public static final Block COLD_GREEN_SILKBULB;
    public static final Block COLD_GREEN_CANDLE;
    public static final Block COLD_GREEN_CANDLE_CAKE;
    ...
    static {
        ...
        CHARTREUSE_WOOL = register("chartreuse_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        CHARTREUSE_CARPET = register("chartreuse_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        CHARTREUSE_TERRACOTTA = register("chartreuse_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        CHARTREUSE_CONCRETE = register("chartreuse_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        CHARTREUSE_CONCRETE_POWDER = register("chartreuse_concrete_powder", new ConcretePowderBlock(CHARTREUSE_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        CHARTREUSE_STAINED_GLASS = register("chartreuse_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        CHARTREUSE_STAINED_GLASS_PANE = register("chartreuse_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        CHARTREUSE_SILKBULB = register("chartreuse_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        CHARTREUSE_CANDLE = register("chartreuse_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        CHARTREUSE_CANDLE_CAKE = register("chartreuse_candle_cake", new CandleCakeBlock(CHARTREUSE_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        MAROON_WOOL = register("maroon_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        MAROON_CARPET = register("maroon_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        MAROON_TERRACOTTA = register("maroon_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        MAROON_CONCRETE = register("maroon_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        MAROON_CONCRETE_POWDER = register("maroon_concrete_powder", new ConcretePowderBlock(MAROON_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        MAROON_STAINED_GLASS = register("maroon_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        MAROON_STAINED_GLASS_PANE = register("maroon_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        MAROON_SILKBULB = register("maroon_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        MAROON_CANDLE = register("maroon_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        MAROON_CANDLE_CAKE = register("maroon_candle_cake", new CandleCakeBlock(MAROON_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        INDIGO_WOOL = register("indigo_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        INDIGO_CARPET = register("indigo_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        INDIGO_TERRACOTTA = register("indigo_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        INDIGO_CONCRETE = register("indigo_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        INDIGO_CONCRETE_POWDER = register("indigo_concrete_powder", new ConcretePowderBlock(INDIGO_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        INDIGO_STAINED_GLASS = register("indigo_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        INDIGO_STAINED_GLASS_PANE = register("indigo_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        INDIGO_SILKBULB = register("indigo_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        INDIGO_CANDLE = register("indigo_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        INDIGO_CANDLE_CAKE = register("indigo_candle_cake", new CandleCakeBlock(INDIGO_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        PLUM_WOOL = register("plum_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        PLUM_CARPET = register("plum_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        PLUM_TERRACOTTA = register("plum_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        PLUM_CONCRETE = register("plum_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        PLUM_CONCRETE_POWDER = register("plum_concrete_powder", new ConcretePowderBlock(PLUM_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        PLUM_STAINED_GLASS = register("plum_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        PLUM_STAINED_GLASS_PANE = register("plum_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        PLUM_SILKBULB = register("plum_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        PLUM_CANDLE = register("plum_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        PLUM_CANDLE_CAKE = register("plum_candle_cake", new CandleCakeBlock(PLUM_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        COLD_GREEN_WOOL = register("cold_green_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        COLD_GREEN_CARPET = register("cold_green_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        COLD_GREEN_TERRACOTTA = register("cold_green_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        COLD_GREEN_CONCRETE = register("cold_green_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        COLD_GREEN_CONCRETE_POWDER = register("cold_green_concrete_powder", new ConcretePowderBlock(COLD_GREEN_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        COLD_GREEN_STAINED_GLASS = register("cold_green_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        COLD_GREEN_STAINED_GLASS_PANE = register("cold_green_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        COLD_GREEN_SILKBULB = register("cold_green_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        COLD_GREEN_CANDLE = register("cold_green_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        COLD_GREEN_CANDLE_CAKE = register("cold_green_candle_cake", new CandleCakeBlock(COLD_GREEN_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        TAN_WOOL = register("tan_wool", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME)));
        TAN_CARPET = register("tan_carpet", new CarpetBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CARPET).mapColor(MapColor.LIME)));
        TAN_TERRACOTTA = register("tan_terracotta", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME)));
        TAN_CONCRETE = register("tan_concrete", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME)));
        TAN_CONCRETE_POWDER = register("tan_concrete_powder", new ConcretePowderBlock(TAN_CONCRETE, AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE_POWDER).mapColor(MapColor.LIME)));
        TAN_STAINED_GLASS = register("tan_stained_glass", new StainedGlassBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS).mapColor(MapColor.LIME)));
        TAN_STAINED_GLASS_PANE = register("tan_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.copy(Blocks.GLASS_PANE).mapColor(MapColor.LIME)));
        TAN_SILKBULB = register("tan_silkbulb", new Block(AbstractBlock.Settings.copy(SILKBULB).mapColor(MapColor.LIME)));
        TAN_CANDLE = register("tan_candle", new CandleBlock(AbstractBlock.Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME)));
        TAN_CANDLE_CAKE = register("tan_candle_cake", new CandleCakeBlock(TAN_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE).mapColor(MapColor.LIME)));

        COLORING_STATION = register("coloring_station", new ColoringStationBlock(AbstractBlock.Settings.copy(Blocks.SMITHING_TABLE)));
    ...
    public static void init(){
        ...
        fire.virtualAdditions$registerFlammableBlock(CHARTREUSE_WOOL, 30, 60);
        fire.virtualAdditions$registerFlammableBlock(CHARTREUSE_CARPET, 60, 20);
        fire.virtualAdditions$registerFlammableBlock(CHARTREUSE_SILKBULB, 5, 20);
        fire.virtualAdditions$registerFlammableBlock(MAROON_WOOL, 30, 60);
        fire.virtualAdditions$registerFlammableBlock(MAROON_CARPET, 60, 20);
        fire.virtualAdditions$registerFlammableBlock(MAROON_SILKBULB, 5, 20);
        fire.virtualAdditions$registerFlammableBlock(INDIGO_WOOL, 30, 60);
        fire.virtualAdditions$registerFlammableBlock(INDIGO_CARPET, 60, 20);
        fire.virtualAdditions$registerFlammableBlock(INDIGO_SILKBULB, 5, 20);
