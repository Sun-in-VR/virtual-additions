...
public class VABlocks {
    ...
    static {
        ...
        COBBLED_HORNFELS = register("cobbled_hornfels", (settings) -> new Block(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        ...
        COBBLED_HORNFELS_SLAB = register("cobbled_hornfels_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        COBBLED_HORNFELS_WALL = register("cobbled_hornfels_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        POLISHED_HORNFELS = register("polished_hornfels", (settings) -> new PillarBlock(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE));
        ...
        POLISHED_HORNFELS_SLAB = register("polished_hornfels_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE_SLAB));
        HORNFELS_TILES = register("hornfels_tiles", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_TILES));
        CRACKED_HORNFELS_TILES = register("cracked_hornfels_tiles", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_TILES));
        ...
        HORNFELS_TILE_SLAB = register("hornfels_tile_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.DEEPSLATE_TILE_SLAB));
        CHISELED_HORNFELS = register("chiseled_hornfels", (settings) -> new Block(settings), Settings.copy(VABlocks.POLISHED_HORNFELS));
        CHISELED_HORNFELS_TILES = register("chiseled_hornfels_tiles", (settings) -> new Block(settings), Settings.copy(VABlocks.HORNFELS_TILES));

        BLUESCHIST = register("blueschist", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE));
        COBBLED_BLUESCHIST = register("cobbled_blueschist", (settings) -> new Block(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        ...
        COBBLED_BLUESCHIST_SLAB = register("cobbled_blueschist_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        COBBLED_BLUESCHIST_WALL = register("cobbled_blueschist_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        POLISHED_BLUESCHIST = register("polished_blueschist", (settings) -> new Block(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE));
        ...
        POLISHED_BLUESCHIST_SLAB = register("polished_blueschist_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE_SLAB));
        BLUESCHIST_BRICKS = register("blueschist_bricks", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_BRICKS));
        CRACKED_BLUESCHIST_BRICKS = register("cracked_blueschist_bricks", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_BRICKS));
        ...
        BLUESCHIST_BRICK_SLAB = register("blueschist_brick_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.DEEPSLATE_BRICK_SLAB));
        BLUESCHIST_BRICK_WALL = register("blueschist_brick_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.DEEPSLATE_BRICK_WALL));
        CHISELED_BLUESCHIST = register("chiseled_blueschist", (settings) -> new Block(settings), Settings.copy(VABlocks.BLUESCHIST_BRICKS));

        SYENITE = register("syenite", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE));
        COBBLED_SYENITE = register("cobbled_syenite", (settings) -> new Block(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        ...
        COBBLED_SYENITE_SLAB = register("cobbled_syenite_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        COBBLED_SYENITE_WALL = register("cobbled_syenite_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.COBBLED_DEEPSLATE));
        POLISHED_SYENITE = register("polished_syenite", (settings) -> new Block(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE));
        ...
        POLISHED_SYENITE_SLAB = register("polished_syenite_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.POLISHED_DEEPSLATE_SLAB));
        SYENITE_BRICKS = register("syenite_bricks", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_BRICKS));
        CRACKED_SYENITE_BRICKS = register("cracked_syenite_bricks", (settings) -> new Block(settings), Settings.copy(Blocks.DEEPSLATE_BRICKS));
        ...
        SYENITE_BRICK_SLAB = register("syenite_brick_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.DEEPSLATE_BRICK_SLAB));
        SYENITE_BRICK_WALL = register("syenite_brick_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.DEEPSLATE_BRICK_WALL));
        CHISELED_SYENITE = register("chiseled_syenite", (settings) -> new Block(settings), Settings.copy(VABlocks.SYENITE_BRICKS));

        ROCK_SALT_BLOCK = register("rock_salt_block", (settings) -> new Block(settings), Settings.copy(Blocks.CALCITE));
        ROCK_SALT_CRYSTAL = register("rock_salt_crystal", (settings) -> new CrystalBlock(settings), Settings.copy(Blocks.AMETHYST_CLUSTER).luminance(state -> 0).sounds(BlockSoundGroup.CALCITE).pistonBehavior(PistonBehavior.DESTROY));

        SPOTLIGHT = register("spotlight", (settings) -> new SpotlightBlock(settings), Settings.copy(STEEL_BLOCK).nonOpaque().luminance((state) -> state.get(SpotlightBlock.POWERED) ? 6 : 0).emissiveLighting((state, world, pos) -> state.get(Properties.POWERED)));
        SPOTLIGHT_LIGHT = register("spotlight_light", (settings) -> new SpotlightLightBlock(settings), Settings.create().sounds(BlockSoundGroup.INTENTIONALLY_EMPTY).replaceable().noCollision().dropsNothing().luminance((state) -> state.get(SpotlightLightBlock.LIT) ? 15 : 0).pistonBehavior(PistonBehavior.DESTROY));

        COTTON = register("cotton", (settings) -> new CottonCropBlock(settings), Settings.create().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP));
        CORN_CROP = register("corn_crop", (settings) -> new CornCropBlock(settings), Settings.create().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP).offset(AbstractBlock.OffsetType.XZ));

        FLOATROCK = register("floatrock", (settings) -> new FloatrockBlock(settings), Settings.copy(Blocks.TUFF));
        GRASSY_FLOATROCK = register("grassy_floatrock", (settings) -> new GrassyFloatrockBlock(settings), Settings.copy(Blocks.TUFF).sounds(GRASSY_FLOATROCK_SOUNDGROUP));
        ...
        FLOATROCK_SLAB = register("floatrock_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.TUFF));
        FLOATROCK_WALL = register("floatrock_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.TUFF));
        FLOATROCK_BRICKS = register("floatrock_bricks", (settings) -> new Block(settings), Settings.copy(Blocks.TUFF_BRICKS));
        ...
        FLOATROCK_BRICK_SLAB = register("floatrock_brick_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.TUFF_BRICKS));
        FLOATROCK_BRICK_WALL = register("floatrock_brick_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.TUFF_BRICKS));
        POLISHED_FLOATROCK = register("polished_floatrock", (settings) -> new Block(settings), Settings.copy(Blocks.POLISHED_TUFF));
        ...
        POLISHED_FLOATROCK_SLAB = register("polished_floatrock_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.POLISHED_TUFF));
        POLISHED_FLOATROCK_WALL = register("polished_floatrock_wall", (settings) -> new WallBlock(settings), Settings.copy(Blocks.POLISHED_TUFF));

        BALLOON_BULB = register("balloon_bulb", (settings) -> new BalloonBulbBlock(settings), Settings.copy(COTTON).mapColor(MapColor.LIGHT_BLUE).offset(AbstractBlock.OffsetType.XZ));
        BALLOON_BULB_PLANT = register("balloon_bulb_plant", (settings) -> new BalloonBulbPlantBlock(settings), Settings.copy(BALLOON_BULB).requires(VirtualAdditions.PREVIEW));
        BALLOON_BULB_BUD = register("balloon_bulb_bud", (settings) -> new BalloonBulbBudBlock(settings), Settings.copy(BALLOON_BULB).requires(VirtualAdditions.PREVIEW));
        ...
        SPRINGSOIL = register("springsoil", (settings) -> new SpringSoilBlock(settings), Settings.copy(Blocks.ROOTED_DIRT).requires(VirtualAdditions.PREVIEW));

        AEROBLOOM_LOG = register("aerobloom_log", (settings) -> new PillarBlock(settings), Settings.copy(Blocks.CHERRY_LOG));
        AEROBLOOM_WOOD = register("aerobloom_wood", (settings) -> new PillarBlock(settings), Settings.copy(Blocks.CHERRY_WOOD));
        STRIPPED_AEROBLOOM_LOG = register("stripped_aerobloom_log", (settings) -> new PillarBlock(settings), Settings.copy(Blocks.STRIPPED_CHERRY_LOG));
        STRIPPED_AEROBLOOM_WOOD = register("stripped_aerobloom_wood", (settings) -> new PillarBlock(settings), Settings.copy(Blocks.STRIPPED_CHERRY_WOOD));
        AEROBLOOM_PLANKS = register("aerobloom_planks", (settings) -> new Block(settings), Settings.copy(Blocks.CHERRY_PLANKS));
        ...
        AEROBLOOM_SLAB = register("aerobloom_slab", (settings) -> new SlabBlock(settings), Settings.copy(Blocks.CHERRY_SLAB));
        AEROBLOOM_FENCE = register("aerobloom_fence", (settings) -> new FenceBlock(settings), Settings.copy(Blocks.CHERRY_SLAB));
        ...
        AEROBLOOM_LEAVES = register("aerobloom_leaves", (settings) -> new LeavesBlock(settings), Settings.copy(Blocks.CHERRY_LEAVES));
        ...
        OAK_HEDGE = register("oak_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.OAK_LEAVES));
        SPRUCE_HEDGE = register("spruce_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.SPRUCE_LEAVES));
        BIRCH_HEDGE = register("birch_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.BIRCH_LEAVES));
        JUNGLE_HEDGE = register("jungle_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.JUNGLE_LEAVES));
        ACACIA_HEDGE = register("acacia_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.ACACIA_LEAVES));
        DARK_OAK_HEDGE = register("dark_oak_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.DARK_OAK_LEAVES));
        MANGROVE_HEDGE = register("mangrove_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.MANGROVE_LEAVES));
        CHERRY_HEDGE = register("cherry_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.CHERRY_LEAVES));
        AEROBLOOM_HEDGE = register("aerobloom_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(VABlocks.AEROBLOOM_LEAVES));
        AZALEA_HEDGE = register("azalea_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.AZALEA_LEAVES));
        FLOWERING_AZALEA_HEDGE = register("flowering_azalea_hedge", (settings) -> new HedgeBlock(settings), Settings.copy(Blocks.FLOWERING_AZALEA_LEAVES));

        GLOWING_SILK = register("glowing_silk", (settings) -> new HangingBlock(settings), Settings.create().mapColor(MapColor.LIGHT_BLUE).sounds(BlockSoundGroup.WART_BLOCK).luminance((state) -> 6).noCollision().nonOpaque().breakInstantly().offset(AbstractBlock.OffsetType.XZ).burnable().pistonBehavior(PistonBehavior.DESTROY));
        FRAYED_SILK = register("frayed_silk", (settings) -> new FrayedSilkBlock(settings), Settings.create().mapColor(MapColor.DARK_AQUA).sounds(BlockSoundGroup.WART_BLOCK).noCollision().nonOpaque().breakInstantly().replaceable().offset(AbstractBlock.OffsetType.XZ).burnable().pistonBehavior(PistonBehavior.DESTROY));
        LUMWASP_NEST = register("lumwasp_nest", (settings) -> new LumwaspNestBlock(settings), Settings.copy(Blocks.HONEYCOMB_BLOCK).sounds(BlockSoundGroup.WART_BLOCK).mapColor(MapColor.DARK_AQUA).burnable());
        SILK_BLOCK = register("silk_block", (settings) -> new SilkBlock(settings), Settings.copy(Blocks.HONEYCOMB_BLOCK).sounds(BlockSoundGroup.WART_BLOCK).mapColor(MapColor.DARK_AQUA).burnable());
        GREENCAP_MUSHROOM = register("greencap_mushroom", (settings) -> new GreencapMushroomBlock(settings), Settings.create().mapColor(MapColor.DARK_GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS).offset(AbstractBlock.OffsetType.XZ).luminance((state) -> 2).pistonBehavior(PistonBehavior.DESTROY));
        TALL_GREENCAP_MUSHROOMS = register("tall_greencap_mushrooms", (settings) -> new TallGreencapMushroomBlock(settings), Settings.create().mapColor(MapColor.DARK_GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS).offset(AbstractBlock.OffsetType.XZ).luminance((state) -> 5).pistonBehavior(PistonBehavior.DESTROY));
        ...
        WEBBED_SILK = register("webbed_silk", (settings) -> new SilkFluffBlock(settings), Settings.create().strength(0.25F).sounds(BlockSoundGroup.POWDER_SNOW).mapColor(MapColor.DARK_AQUA).nonOpaque().solidBlock((state, world, pos) -> false).suffocates(((state, world, pos) -> false)).blockVision((state, world, pos) -> false).burnable().allowsSpawning((state, world, pos, type) -> type == VAEntityType.LUMWASP));
        SILKBULB = register("silkbulb", (settings) -> new Block(settings), Settings.copy(Blocks.SHROOMLIGHT).mapColor(MapColor.DARK_AQUA).luminance( (state) -> 15 ).burnable());
        WHITE_SILKBULB = register("white_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.WHITE));
        LIGHT_GRAY_SILKBULB = register("light_gray_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIGHT_GRAY));
        GRAY_SILKBULB = register("gray_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.GRAY));
        BLACK_SILKBULB = register("black_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.BLACK));
        BROWN_SILKBULB = register("brown_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.BROWN));
        RED_SILKBULB = register("red_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.RED));
        ORANGE_SILKBULB = register("orange_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.ORANGE));
        YELLOW_SILKBULB = register("yellow_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.YELLOW));
        LIME_SILKBULB = register("lime_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        GREEN_SILKBULB = register("green_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.GREEN));
        CYAN_SILKBULB = register("cyan_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.CYAN));
        LIGHT_BLUE_SILKBULB = register("light_blue_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIGHT_BLUE));
        BLUE_SILKBULB = register("blue_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.BLUE));
        PURPLE_SILKBULB = register("purple_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.PURPLE));
        MAGENTA_SILKBULB = register("magenta_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.MAGENTA));
        PINK_SILKBULB = register("pink_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.PINK));

        CHARTREUSE_WOOL = register("chartreuse_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        CHARTREUSE_TERRACOTTA = register("chartreuse_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        CHARTREUSE_CONCRETE = register("chartreuse_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        CHARTREUSE_SILKBULB = register("chartreuse_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        CHARTREUSE_CANDLE = register("chartreuse_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        CHARTREUSE_GLAZED_TERRACOTTA = register("chartreuse_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.CHARTREUSE));
        
        MAROON_WOOL = register("maroon_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        MAROON_TERRACOTTA = register("maroon_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        MAROON_CONCRETE = register("maroon_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        MAROON_SILKBULB = register("maroon_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        MAROON_CANDLE = register("maroon_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        MAROON_GLAZED_TERRACOTTA = register("maroon_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.MAROON));

        INDIGO_WOOL = register("indigo_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        INDIGO_TERRACOTTA = register("indigo_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        INDIGO_CONCRETE = register("indigo_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        INDIGO_SILKBULB = register("indigo_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        INDIGO_CANDLE = register("indigo_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        INDIGO_GLAZED_TERRACOTTA = register("indigo_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.INDIGO));

        PLUM_WOOL = register("plum_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        PLUM_TERRACOTTA = register("plum_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        PLUM_CONCRETE = register("plum_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        PLUM_SILKBULB = register("plum_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        PLUM_CANDLE = register("plum_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        PLUM_GLAZED_TERRACOTTA = register("plum_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.PLUM));

        VIRIDIAN_WOOL = register("viridian_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        VIRIDIAN_TERRACOTTA = register("viridian_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        VIRIDIAN_CONCRETE = register("viridian_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        VIRIDIAN_SILKBULB = register("viridian_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        VIRIDIAN_CANDLE = register("viridian_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        VIRIDIAN_GLAZED_TERRACOTTA = register("viridian_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.VIRIDIAN));

        TAN_WOOL = register("tan_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        TAN_TERRACOTTA = register("tan_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        TAN_CONCRETE = register("tan_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        TAN_SILKBULB = register("tan_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        TAN_CANDLE = register("tan_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        TAN_GLAZED_TERRACOTTA = register("tan_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.TAN));

        SINOPIA_WOOL = register("sinopia_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        SINOPIA_TERRACOTTA = register("sinopia_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        SINOPIA_CONCRETE = register("sinopia_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        SINOPIA_SILKBULB = register("sinopia_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        SINOPIA_CANDLE = register("sinopia_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        SINOPIA_GLAZED_TERRACOTTA = register("sinopia_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.SINOPIA));

        LILAC_WOOL = register("lilac_wool", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_WOOL).mapColor(MapColor.LIME));
        ...
        LILAC_TERRACOTTA = register("lilac_terracotta", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_TERRACOTTA).mapColor(MapColor.LIME));
        LILAC_CONCRETE = register("lilac_concrete", (settings) -> new Block(settings), Settings.copy(Blocks.WHITE_CONCRETE).mapColor(MapColor.LIME));
        ...
        LILAC_SILKBULB = register("lilac_silkbulb", (settings) -> new Block(settings), Settings.copy(SILKBULB).mapColor(MapColor.LIME));
        LILAC_CANDLE = register("lilac_candle", (settings) -> new CandleBlock(settings), Settings.copy(Blocks.CANDLE).mapColor(MapColor.LIME));
        ...
        LILAC_GLAZED_TERRACOTTA = register("lilac_glazed_terracotta", (settings) -> new GlazedTerracottaBlock(settings), Settings.copy(Blocks.WHITE_GLAZED_TERRACOTTA).mapColor(VADyeColors.LILAC));

        COLORING_STATION = register("coloring_station", (settings) -> new ColoringStationBlock(settings), Settings.copy(Blocks.SMITHING_TABLE));
        ...
        ACID_BLOCK = register("acid_block", (settings) -> new AcidBlock(settings), Settings.create().mapColor(MapColor.LIME).breakInstantly().sounds(BlockSoundGroup.HONEY).nonOpaque().solidBlock((state, world, pos) -> false));
        ...
        IOLITE_BLOCK = register("iolite_block", (settings) -> new Block(settings), Settings.create().mapColor(MapColor.MAGENTA).sounds(BlockSoundGroup.METAL).requiresTool().hardness(5.0F).resistance(300.0F));
        WARP_ANCHOR = register("warp_anchor", (settings) -> new WarpAnchorBlock(settings), Settings.create().nonOpaque().sounds(BlockSoundGroup.NETHERITE).luminance(state -> 3).emissiveLighting( (state, world, pos) -> !state.get(WarpAnchorBlock.POWERED) ).hardness(22.5F).requiresTool().resistance(600.0F));
        WARP_TETHER = register("warp_tether", (settings) -> new WarpTetherBlock(settings), Settings.create().nonOpaque().sounds(BlockSoundGroup.NETHERITE).luminance(state -> 3).emissiveLighting( (state, world, pos) -> !state.get(WarpTetherBlock.COOLDOWN) ).hardness(22.5F).requiresTool().resistance(600.0F));
        ENTANGLEMENT_DRIVE = register("entanglement_drive", (settings) -> new EntanglementDriveBlock(settings), Settings.create().nonOpaque().sounds(BlockSoundGroup.NETHERITE).luminance(state -> 3).emissiveLighting( (state, world, pos) -> !state.get(Properties.POWERED) ).hardness(22.5F).requiresTool().resistance(600.0F));

        DESTRUCTIVE_SCULK = register("destructive_sculk", (settings) -> new DestructiveSculkBlock(settings), Settings.copy(Blocks.SCULK));
        WIND = register("wind", (settings) -> new WindBlock(settings), Settings.copy(Blocks.AIR));
