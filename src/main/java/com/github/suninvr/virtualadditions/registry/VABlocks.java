...
public class VABlocks {
    ...
    public static final Block WISBERRY;
    ...
    static {
        ...
        WISBERRY = register("wisberry", WisberryCropBlock::new, Settings.create().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP));
